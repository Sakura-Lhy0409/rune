...
| **当前里程碑** | ✅ **M1-7 上下文预算制装配器 + L1 结构化裁剪**（487 测试全绿）—— 纯逻辑继续推进中，下一步见 §7 |
| **上一个完成的里程碑** | ✅ **M1-7：上下文预算制装配器 + L1 结构化裁剪**（487 测试全绿） |
| **已完成里程碑** | ✅ M0 全部（…→**258 出口验收达成**）→ ✅ M1-1 ToolScheduler（282）→ ✅ M1-2 协议适配器（328）→ ✅ M1-3 波次调度（341）→ ✅ M1-4 计划与审批（379）→ ✅ M1-5 GoalEngine（405）→ ✅ M1-6 修正性重试 + 协议不变式（447）→ ✅ **M1-7 上下文装配器（487）** |
| **阻塞项** | 无 |
...
设计文档      ████████████████████ 100%
M0 地基       ████████████████████ 100%   ✅ 出口验收已达成
M1 可用内核   ███████████████░░░░  75%   ← 纯逻辑继续推进（下一步：ToolSpec 全量声明 / 混合检索融合）
M2 移动体验   ░░░░░░░░░░░░░░░░░░░░░   0%
M3 多渠道     ░░░░░░░░░░░░░░░░░░░░░   0%
M4 端侧+记忆  ░░░░░░░░░░░░░░░░░░░░░   0%
M5 上架准备   ░░░░░░░░░░░░░░░░░░░░░   0%
...
`RuneKernel` 现在有 **26 个源文件、487 项测试**，覆盖：值类型与协议、补丁引擎、检索、
...
1. ✅ **已做**：上下文装配器（`Context.swift`，C18）。**剩下的**是把 L3 主模型压缩的
   编排接起来（装配器只报告，运行时负责花钱并落事件）。
...
└─ Packages/
   ├─ RuneKernel/            ✅ 零依赖核心（26 源文件 / 487 测试全绿）
